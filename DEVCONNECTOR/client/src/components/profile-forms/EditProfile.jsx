...
const EditProfile = ({
  ...
  /*
   * The seoncd arugment, or the stuff after {} and in the [] means that
   * the useEffect will depend on loading/it will run when loading is true, or
   * when it loads
   * Look at colt's react document on google doc, and go through the useEffect section
   */
  useEffect(() => {
    getCurrentProfile();
